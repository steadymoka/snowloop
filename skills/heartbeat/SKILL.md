...
- `.tars/protocol/PROTOCOL.md`가 없으면: "tars이 초기화되지 않았습니다. `/tars:init`을 먼저 실행하세요." 출력 후 종료
- `.tars/PROGRESS.md`가 없으면: 위와 동일
- 작업 실행 중 에러 발생 시: LOG에 에러 기록, 다음 heartbeat로 넘기기

## 연속 운영

`/loop 10m /tars:heartbeat` 명령으로 10분마다 자동 실행할 수 있습니다.
