...
다음 파일을 읽습니다:
- `.tars/protocol/EVOLUTION.md` — 전체 변경 이력
- `.tars/logs/RETRO.md` — 모든 RETRO 기록
- `.tars/protocol/PROTOCOL.md` — 현재 프로토콜
...
- RETRO가 없으면: "RETRO가 없습니다. `/tars:retro`를 먼저 실행하세요."
