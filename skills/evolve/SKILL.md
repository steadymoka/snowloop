...
다음 파일을 읽습니다:
- `.snowloop/EVOLUTION.md` — 전체 변경 이력
- `.snowloop/RETRO.md` — 모든 RETRO 기록
- `.snowloop/PROTOCOL.md` — 현재 프로토콜
...
사용자가 개선안을 선택하면:
- Parameter patch → PROTOCOL.md에 즉시 적용 + EVOLUTION.md 기록
- Structural patch → COMMS에 `[→human] [PROTOCOL-PATCH]` 제안 등록
